...
<head>
    ...
    {!!Html::style('css/bootstrap.min.css')!!} <!--LARAVEL COLLECTIVE -->
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{!!URL::to('/usuario')!!}">Administrador</a>
            </div>
        ...
        <div id="page-wrapper">
            @yield('content') <!--Se define donde va a estar el contenido HTML -->
         </div>
